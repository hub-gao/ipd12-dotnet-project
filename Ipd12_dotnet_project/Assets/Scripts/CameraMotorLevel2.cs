...
public class CameraMotorLevel2 : MonoBehaviour
{
    ...
    public float xTilt;
    Vector3 destination;
    CharacterMotorLevel2 characterMotor;
    ...
    public void SetCameraTarget(Transform t)
    {
        ...
        if (target != null)
        {
            if (target.GetComponent<CharacterMotorLevel2>())
            {
                characterMotor = target.GetComponent<CharacterMotorLevel2>();
            }
            else
